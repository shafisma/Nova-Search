import { Clock, Edit, Share, Trash, FileText, FileDown, Settings } from 'lucide-react';
  ...
  return (
    <div className="fixed z-40 top-0 left-0 right-0 px-4 lg:pl-[104px] lg:pr-6 lg:px-8 flex flex-row items-center justify-between w-full py-4 text-sm text-black dark:text-white/70 border-b bg-light-primary dark:bg-dark-primary border-light-100 dark:border-dark-200">
      ...
      <div className="flex flex-row items-center space-x-4">
        <a
          href="/settings"
          className="active:scale-95 transition duration-100 cursor-pointer p-2 rounded-full hover:bg-light-secondary dark:hover:bg-dark-secondary"
          title="Settings"
        >
          <Settings size={17} />
        </a>
